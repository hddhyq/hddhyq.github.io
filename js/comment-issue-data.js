...
var repoIssuesUrl = "https://api.github.com/repos/hddhyq/blog_comments/issues";
// 对应仓库 clientId、clientSecret 关于这两个参数的安全问题，查看 https://removeif.github.io/2019/09/19/博客源码分享.html#1-热门推荐，最新评论：
var clientId = "a03371b663a2b8d82494";
var clientSecret = "4ef09e925b4d1c73a5e16d5f7a811bcc2e787c4c";
...
function loadIssueData() {
    setTimeout(function () { // 延迟1s执行，保证其余的先加载
        ...
        console.clear();
        console.log("~~~~欢迎光临！记得有时间多来看看哦，https://hddhyq.github.io/ ~~~~")
    }
    ,
    500
)
